...
function BulkUpload() {
  ...
  if (!isReviewing) {
    return (
        <div className="max-w-4xl mx-auto pt-10 px-4 sm:px-6 relative">
          <button 
              onClick={() => router.navigate({ to: '/' })}
              className="absolute top-10 left-4 sm:left-6 px-4 py-2 text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 font-bold tracking-wide rounded-xl transition-colors text-sm flex items-center gap-2 z-10"
          >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="m15 18-6-6 6-6"/></svg>
              Back
          </button>
          
          <div className="mb-10 text-center flex flex-col items-center mt-12 sm:mt-0">
